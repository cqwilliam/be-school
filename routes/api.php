...
Route::middleware(JWTMiddleware::class)->group(function () {
    ...
    Route::get('/teachers/{teacher_user_id}/course-materials', [UserController::class, 'getTeacherCourseMaterials']);
    Route::get('/students/{student_user_id}/evaluationstypes', [UserController::class, 'getStudentTypesEvaluations']);
    Route::get('/students/{student_user_id}/course-teachers', [UserController::class, 'getCourseTeachers']);
    ...
    Route::get('/students/{student_user_id}/student-sections', [UserController::class, 'getStudentsBySection']);

    Route::get('/students/{student_user_id}/schedules', [UserController::class, 'getStudentSchedules']);
